 ...
 */
final class Version20231107124149 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plantes (id INT AUTO_INCREMENT NOT NULL, nom_plante VARCHAR(255) NOT NULL, description_plante LONGTEXT NOT NULL, prix_plante DOUBLE PRECISION NOT NULL, stock INT NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
