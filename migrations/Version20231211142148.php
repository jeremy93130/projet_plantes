 ...
 */
final class Version20231211142148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quantites CHANGE commande_id commande_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE quantites CHANGE commande_id commande_id INT NOT NULL');
    }
}
